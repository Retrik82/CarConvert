...
BACKGROUND_REPLACE_SYSTEM_PROMPT = (
    ...
    "Goal:\n"
    "Edit the provided SOURCE PHOTOGRAPH in place. Replace ONLY the background pixels. "
    "The vehicle region will be restored from the original — your job is the environment only.\n\n"
    "Rules:\n"
    "- The attached user photo is the SOURCE. Match its exact dimensions, crop, and camera geometry.\n"
    "- Replace ONLY background pixels: sky, ground, walls, buildings, scenery, and environment.\n"
    "- Do NOT change camera angle, perspective, focal length, horizon, or vehicle position in frame.\n"
    "- Do NOT modify, enhance, restyle, or regenerate any part of the vehicle.\n"
    "- Do NOT remove or alter license plates, badges, stickers, trim, wheels, or any vehicle detail.\n"
    "- Match new background lighting and ground contact naturally around the unchanged vehicle silhouette.\n"
...
def _build_background_replace_user_text(
    ...
    *,
    ...
    return (
        ...
        f"{vehicle_rule} "
        "Keep the exact same camera angle, perspective, crop, and vehicle placement. "
        "Do not change vehicle model, color, body, wheels, license plate, badges, or shooting angle. "
        "Do not remove or alter any vehicle text, numbers, or small details. "
        "Improve only background and overall photo quality — the car itself must stay identical."
    )
